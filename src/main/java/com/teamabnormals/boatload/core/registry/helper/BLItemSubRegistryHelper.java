...
public class BLItemSubRegistryHelper extends ItemSubRegistryHelper {
	...
	public RegistryObject<Item> createChestBoat(ExtraBoatType type, String... modIds) {
	...
	public RegistryObject<Item> createFurnaceBoat(ExtraBoatType type, String... modIds) {
	...
	public RegistryObject<Item> createLargeBoat(ExtraBoatType type, String... modIds) {
