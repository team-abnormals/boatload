...
public class Boatload {
	...
	private void registerLayerDefinitions(EntityRenderersEvent.RegisterLayerDefinitions event) {
		for (BoatloadBoatType boatType : BoatloadBoatType.values()) {
			...
			event.registerLayerDefinition(BoatloadModelLayers.createFurnaceBoatModelName(boatType), boatType.raft() ? FurnaceRaftModel::createFurnaceRaftBodyModel : FurnaceBoatModel::createFurnaceBoatBodyModel);
			event.registerLayerDefinition(BoatloadModelLayers.createLargeBoatModelName(boatType), boatType.raft() ? LargeRaftModel::createBodyModel : LargeBoatModel::createBodyModel);
		}
	}
