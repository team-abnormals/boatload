...
public class FurnaceBoat extends EBBoat {
	...
	public FurnaceBoat(Level worldIn, double x, double y, double z) {
		this(EBEntityTypes.FURNACE_BOAT.get(), worldIn);
		this.setPos(x, y, z);
	...
	public FurnaceBoat(PlayMessages.SpawnEntity packet, Level worldIn) {
		super(EBEntityTypes.FURNACE_BOAT.get(), worldIn);
	}
	...
	public Item getDropItem() {
		return this.getEBBoatType().getFurnaceBoat();
	}
