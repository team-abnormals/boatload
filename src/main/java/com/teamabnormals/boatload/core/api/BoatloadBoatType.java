...
public record BoatloadBoatType(ResourceLocation registryName, Supplier<Item> planks, Supplier<Item> boat, Supplier<Item> chestBoat, Supplier<Item> furnaceBoat, Supplier<Item> largeBoat) {
	...
	public static final BoatloadBoatType CRIMSON = register(create(new ResourceLocation("crimson"), () -> Items.CRIMSON_PLANKS, () -> BoatloadItems.CRIMSON_BOAT.get(), () -> BoatloadItems.CRIMSON_CHEST_BOAT.get(), () -> BoatloadItems.CRIMSON_FURNACE_BOAT.get(), () -> BoatloadItems.LARGE_CRIMSON_BOAT.get()));
	public static final BoatloadBoatType WARPED = register(create(new ResourceLocation("warped"), () -> Items.WARPED_PLANKS, () -> BoatloadItems.WARPED_BOAT.get(), () -> BoatloadItems.WARPED_CHEST_BOAT.get(), () -> BoatloadItems.WARPED_FURNACE_BOAT.get(), () -> BoatloadItems.LARGE_WARPED_BOAT.get()));
